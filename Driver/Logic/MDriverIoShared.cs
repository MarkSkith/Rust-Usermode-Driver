namespace MDriver.Logic
{
    ...
    using global::MDriver.Native.Enums;

    using Microsoft.Win32.SafeHandles;

    public class MDriverIoShared : MIDriverIo
    {
        /// <summary>
        /// Gets or sets the <see cref="MIDriver" />.
        /// </summary>
        public MIDriver Driver
        {
            get;
        }
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="MDriverIo"/> is connected.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="MDriverIoShared"/> is disposed.
        /// </summary>
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="MDriverIoShared"/> class from being created.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MDriverIoShared"/> class.
        /// </summary>
        ...
        public void Connect()
        {
            ...
            if (Status > 0x00)
            {
                ...
                Log.Error(typeof(MDriverIoShared), "Failed to open the first event object. [" + Status + "]");
                return;
            }
            ...
            if (Status > 0x00)
            {
                ...
                Log.Error(typeof(MDriverIoShared), "Failed to open the second event object. [" + Status + "]");
                return;
            }
